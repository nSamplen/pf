...
function moveFiles {
   ...
   su -p oracle -c "mv $ORACLE_HOME/dbs/spfileXE.ora $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/"
   su -p oracle -c "mv $ORACLE_HOME/dbs/orapwXE $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/"
...
function symLinkFiles {
   ...
   if [ ! -L $ORACLE_HOME/dbs/spfileXE.ora ]; then
      ln -s $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/spfileXE.ora $ORACLE_HOME/dbs/spfileXE.ora
   fi;
   
   if [ ! -L $ORACLE_HOME/dbs/orapw$ORACLE_SID ]; then
      ln -s $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/orapwXE $ORACLE_HOME/dbs/orapwXE
   fi;
